  ...
  return (
    <>
      ...
      <div className="contact-us-container" style={{width:"auto"}}>
        ...
        <h2 style={{ textAlign: "center",marginTop: "40px" }}>Réseaux sociaux</h2>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
        ...
        <div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15435.710270532607!2d-17.467697649999998!3d14.716687049999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xacb4cc714e94e7db%3A0x746f0e2517e84782!2sRostel%20High-Tech!5e0!3m2!1sfr!2ssn!4v1702436162616!5m2!1sfr!2ssn" width="560" height="350" style={{border:"0",marginTop:"40px",borderRadius:"17px"}}  allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
      <FakeFooter />
    </>
